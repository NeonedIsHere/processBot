        ...
        pm2.connect((err) => {
            ...
            pm2.restart(parseInt(procId), (err) => {
                if (err) {
                    ...
                    return interaction.reply({
                        content: 'Erreur lors du démarrage du processus.',
                        ephemeral: true
                    });
                }
                ...
                pm2.describe(parseInt(procId), (err, processInfo) => {
                    ...
                    const mem = (proc.monit.memory / 1024 / 1024).toFixed(2);
                    ...
                    logsAction(client, interaction.user.id, 'pm2_start', proc.pm_id, proc.name);
